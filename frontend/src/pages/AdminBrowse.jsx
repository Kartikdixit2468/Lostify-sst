...
export default function Admin() {
  ...
  const fetchData = async () => {
    try {
      const [statsRes, postsRes] = await Promise.all([
        axios.get('https://lostify-4z5d.onrender.com/api/posts/stats/admin'),
        axios.get('https://lostify-4z5d.onrender.com/api/posts/admin/all')
      ]);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://lostify-4z5d.onrender.com/api/posts/${id}`);
  ...
  const handleFlag = async (id) => {
    try {
      await axios.patch(`https://lostify-4z5d.onrender.com/api/posts/admin/${id}`, { status: 'flagged' });
  ...
  const handleSaveNote = async (id) => {
    try {
      await axios.patch(`https://lostify-4z5d.onrender.com/api/posts/admin/${id}`, { adminNote });
  ...
  const handleExportCSV = async () => {
    try {
      const response = await axios.get('https://lostify-4z5d.onrender.com/api/posts/export/csv', {
        responseType: 'blob'
      });
