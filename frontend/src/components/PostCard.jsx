    ...
    >
      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3 className="text-lg sm:text-xl font-heading font-bold text-charcoal dark:text-white break-words flex-1">
            {post.title}
          </h3>
          <motion.span
        ...
        <div className="space-y-1 text-xs sm:text-sm text-charcoal/60 dark:text-white/60 mb-4">
          ...
          <p className="flex items-center gap-2 break-words">
            ...
            <span className="break-words">Posted by {post.username.split(".")[0]}</span>
          </p>
        </div>
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-2 bg-found hover:bg-found/90 text-white font-heading font-semibold py-3 px-4 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg text-sm sm:text-base min-h-[44px]"
        >
          ...
          <span>{post.type === "lost" ? "Message Finder" : "Message Owner"}</span>
        </motion.button>
      </div>
    </motion.div>
    </>
